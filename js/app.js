...
function generateGeneralPdf(){
  ...
  try{
    ...
    */
    ...
    /*
      Título e declaração no mesmo padrão do relatório dos hidrantes.
      Quando não houver espaço, a seção é transferida para uma nova página.
    */
    let signatureTitleY = finalY + 58;

    if(signatureTitleY > pageHeight-178){
      doc.addPage();
      drawHeader();
      signatureTitleY = 92;
    }
    ...
    /*
      Linha posicionada mais abaixo, oferecendo uma área livre maior
      para assinatura, rubrica e carimbo.
    */
    const signatureLineY = signatureTitleY + 104;

    const signatureBlocks = [
      {
        label:'Responsável pela inspeção',
        sublabel:'Nome, assinatura e carimbo'
      },
      {
    ...
    <div class="modal">
      ...
      <div class="modal-body">
        <div style="display:flex;align-items:center;gap:14px;margin-bottom:18px;">
          ...
          <div>
            <div style="font-family:var(--font-display);font-size:18px;font-weight:700;">Gestão de Extintores</div>
            <div style="font-size:11px;color:var(--muted);margin-top:4px;">PWA Enterprise v4.0.8 · Assinaturas no Relatório de Extintores</div>
          </div>
        </div>
