...
function openHydrantModal(hydrantId=null){
  ...
  openModal(`
    <div
      class="modal ${editing?'':'inspection-form-modal hydrant-registration-modal'}"
      ${editing?'':'style="max-width:820px;"'}>
    ...
    <div class="modal">
      ...
      <div class="modal-body">
        <div style="display:flex;align-items:center;gap:14px;margin-bottom:18px;">
          ...
          <div>
            <div style="font-family:var(--font-display);font-size:18px;font-weight:700;">Gestão de Extintores</div>
            <div style="font-size:11px;color:var(--muted);margin-top:4px;">PWA Enterprise v4.0.1 · Cadastro e Layout de Hidrantes</div>
          </div>
        </div>
