...
async function persistHydrantDeletion(hydrantId,hydrant=null){
  ...
  saveLocalKey('deletedHydrantIds',[...DELETED_HYDRANT_IDS]);
  await discardQueuedUpsert('hydrants',targetId);
  await enqueueOfflineOperation({
    type:'delete',collection:'hydrants',documentId:targetId,
    tombstone:{
      id:targetId,
      numero:hydrant?.numero || '',
      usina:hydrant?.usina || currentUserUsina() || 'TODAS',
      localizacao:hydrant?.localizacao || '',
      deleted:true
    }
  });
}
    ...
    <div class="modal">
      ...
      <div class="modal-body">
        <div style="display:flex;align-items:center;gap:14px;margin-bottom:18px;">
          ...
          <div>
            <div style="font-family:var(--font-display);font-size:18px;font-weight:700;">Gestão de Extintores</div>
            <div style="font-size:11px;color:var(--muted);margin-top:4px;">PWA Enterprise v4.1.1 · Fotos Novas no Storage</div>
          </div>
        </div>
