      ...
      <div class="card storage-diagnostic-card">
        ...
        <div class="storage-diagnostic-intro">
          ...
          <span class="storage-diagnostic-badge">
            NÃO MIGRA FOTOS ANTIGAS
          </span>
        </div>

        <p class="storage-diagnostic-copy">
          Esta etapa apenas prepara o armazenamento de imagens.
          Os extintores e hidrantes atuais continuam usando exatamente
          as fotos existentes.
        </p>
    ...
    <div class="modal">
      ...
      <div class="modal-body">
        <div style="display:flex;align-items:center;gap:14px;margin-bottom:18px;">
          ...
          <div>
            <div style="font-family:var(--font-display);font-size:18px;font-weight:700;">Gestão de Extintores</div>
            <div style="font-size:11px;color:var(--muted);margin-top:4px;">PWA Enterprise v4.1.2 · Fotos Novas dos Hidrantes no Storage</div>
          </div>
        </div>
