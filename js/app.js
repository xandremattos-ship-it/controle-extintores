  ...
  document.getElementById('account-check-status')
    ?.addEventListener('click',async event=>{
      ...
      try{
        ...
        showToast(
          'Não foi possível consultar a liberação. Tente novamente.',
          'err'
        );
      }
    });
    ...
    <div class="modal">
      ...
      <div class="modal-body">
        <div style="display:flex;align-items:center;gap:14px;margin-bottom:18px;">
          ...
          <div>
            <div style="font-family:var(--font-display);font-size:18px;font-weight:700;">Gestão de Extintores</div>
            <div style="font-size:11px;color:var(--muted);margin-top:4px;">PWA Enterprise v3.2.12 · Autocadastro de Usuários</div>
          </div>
        </div>
