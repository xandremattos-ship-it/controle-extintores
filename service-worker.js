const CACHE_VERSION = 'gestao-extintores-v3.2.12.3-cartao-compartilhamento';
const APP_SHELL = [
  './',
  './index.html',
  './manifest.json',
  ...
  './favicon-16x16.png',
  './favicon.ico',
  './share-preview-v3.2.12.3.png',
  './css/app.css?v=3.2.12.3',
  './css/offline.css?v=3.2.12.3',
  './js/offline.js?v=3.2.12.3',
  './js/app.js?v=3.2.12.3'
];
