const CACHE_VERSION = 'gestao-extintores-v3.2.11.2-correcao-nc-cadastro';
const APP_SHELL = [
  './',
  './index.html',
  './manifest.json',
  ...
  './favicon-16x16.png',
  './favicon.ico',
  './css/app.css?v=3.2.11.2',
  './css/offline.css?v=3.2.11.2',
  './js/offline.js?v=3.2.11.2',
  './js/app.js?v=3.2.11.2'
];
