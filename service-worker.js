const CACHE_VERSION = 'gestao-extintores-v3.2.13.1-notificacoes-estaveis';
const APP_SHELL = [
  './',
  './index.html',
  './manifest.json',
  ...
  './css/app.css?v=3.2.13.1',
  './css/offline.css?v=3.2.13.1',
  './js/offline.js?v=3.2.13.1',
  './js/app.js?v=3.2.13.1'
];
