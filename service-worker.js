const CACHE_VERSION = 'gestao-extintores-v3.2.10.1-lista-mobile-lateral';
const APP_SHELL = [
  './',
  './index.html',
  './manifest.json',
  ...
  './favicon-16x16.png',
  './favicon.ico',
  './css/app.css?v=3.2.10.1',
  './css/offline.css?v=3.2.10.1',
  './js/offline.js?v=3.2.10.1',
  './js/app.js?v=3.2.10.1'
];
